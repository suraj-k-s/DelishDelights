      ...
      <div className="right">
        ...
        <div className="btns flex gap-5">
          <button
            ...
            className={`bg-gradient-to-br p-3 px-8 rounded-lg text-sm uppercase font-medium tracking-wider mt-2 inline-block shadow-md hover:shadow-lg  duration-300 ${itemSavedStatus
